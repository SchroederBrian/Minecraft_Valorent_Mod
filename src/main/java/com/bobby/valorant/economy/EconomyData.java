...
public final class EconomyData {
    ...
    private static boolean matchesSlot(ItemStack s, ShopItem.Slot slot) {
        ...
        return switch (slot) {
            case SECONDARY -> s.is(com.bobby.valorant.registry.ModItems.CLASSIC.get()) || s.is(com.bobby.valorant.registry.ModItems.GHOST.get()) || s.is(com.bobby.valorant.registry.ModItems.SHERIFF.get()) || s.is(com.bobby.valorant.registry.ModItems.FRENZY.get());
